    ...
    : AbstractValidator<CreateEmployeeCommand>
{
    public CreateEmployeeCommandValidator()
    {
        ...
        RuleFor(x => x.Request.Governorate)
            .MaximumLength(100)
            .When(x => !string.IsNullOrWhiteSpace(x.Request.Governorate));
        ...
        RuleFor(x => x.Request.ResidentialAddress)
            .MaximumLength(300)
        ...
        RuleFor(x => x.Request.EmployeeCode)
            ...
            .When(x => !string.IsNullOrWhiteSpace(x.Request.EmployeeCode));
    }
}