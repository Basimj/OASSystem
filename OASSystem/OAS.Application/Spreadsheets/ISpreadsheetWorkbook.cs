...
public sealed record SpreadsheetColumn(string Key, bool Required = false, string DataType = "text", string? DefaultValue = null, IReadOnlyList<string>? AllowedValues = null, string? Format = null);
public sealed record SpreadsheetSheet(string Name, IReadOnlyList<SpreadsheetColumn> Columns);
