...
public static class JournalEntryMapping
{
        ...
        JournalEntry journal)
    {
        return new JournalEntryDto(
            ...
            (OAS.Contracts.Accounting.Enums.JournalType)
                (int)journal.JournalType,
            journal.PostingDate,
            ...
            (OAS.Contracts.Accounting.Enums.JournalEntryStatus)
                (int)journal.Status,
    ...
    private static JournalEntryLineDto ToLineDto(
