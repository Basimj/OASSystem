...
public partial class UiSelect
{
    ...
    private string InputCssClass => $"ui-select__control ui-select__control--{Size.ToString().ToLowerInvariant()} {(HasError ? "ui-select__control--invalid" : null)} {CssClass}".Trim();
