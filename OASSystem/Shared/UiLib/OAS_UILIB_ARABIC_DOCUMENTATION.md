...
في الاستضافة الحالية يتم تحميل ملفات UiLib من `OAS.API/Components/App.razor`:

```html
<link rel="stylesheet" href="_content/OAS.UiLib/css/variables.css" />
<link rel="stylesheet" href="_content/OAS.UiLib/css/colors.css" />
<link rel="stylesheet" href="_content/OAS.UiLib/css/sizing.css" />
<link rel="stylesheet" href="_content/OAS.UiLib/css/bootstrap-loader.css" />
<link rel="stylesheet" href="_content/OAS.UiLib/OAS.UiLib.bundle.scp.css" />
```

آخر ملف هو ناتج CSS Isolation الخاص بالمكونات.
...
- `wwwroot/css/bootstrap-loader.css` — CSS عام/Design Tokens أو Bootstrap loader.
- `wwwroot/css/colors.css` — CSS عام/Design Tokens أو Bootstrap loader.
- `wwwroot/css/sizing.css` — CSS عام/Design Tokens أو Bootstrap loader.
- `wwwroot/css/variables.css` — CSS عام/Design Tokens أو Bootstrap loader.
