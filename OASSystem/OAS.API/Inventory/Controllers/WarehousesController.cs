...
public sealed class WarehousesController(
    ICrudApplicationService<Guid, WarehouseDto, CreateWarehouseRequest, UpdateWarehouseRequest> service,
    IPermissionChecker permissionChecker) : ControllerBase
{
    [HttpGet]
    public async Task<ActionResult<PagedResult<WarehouseDto>>> Get(
        [FromQuery] PageRequest request,
        CancellationToken cancellationToken)
    {
        await EnsurePermissionAsync(InventoryPermissions.Warehouses.View, cancellationToken);
    ...
    public async Task<ActionResult<WarehouseDto>> Create(
        ...
        CancellationToken cancellationToken)
    {
        await EnsurePermissionAsync(InventoryPermissions.Warehouses.Create, cancellationToken);
    ...
    public async Task<ActionResult<WarehouseDto>> Update(
        ...
        CancellationToken cancellationToken)
    {
        await EnsurePermissionAsync(InventoryPermissions.Warehouses.Edit, cancellationToken);
