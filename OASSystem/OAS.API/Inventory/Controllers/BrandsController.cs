...
public sealed class BrandsController(
    ICrudApplicationService<Guid, BrandDto, CreateBrandRequest, UpdateBrandRequest> service,
    IPermissionChecker permissionChecker) : ControllerBase
{
    [HttpGet]
    public async Task<ActionResult<PagedResult<BrandDto>>> Get(
        [FromQuery] PageRequest request,
        CancellationToken cancellationToken)
    {
        await EnsurePermissionAsync(InventoryPermissions.Brands.View, cancellationToken);
    ...
    public async Task<ActionResult<BrandDto>> Create(
        ...
        CancellationToken cancellationToken)
    {
        await EnsurePermissionAsync(InventoryPermissions.Brands.Create, cancellationToken);
    ...
    public async Task<ActionResult<BrandDto>> Update(
        ...
        CancellationToken cancellationToken)
    {
        await EnsurePermissionAsync(InventoryPermissions.Brands.Edit, cancellationToken);
